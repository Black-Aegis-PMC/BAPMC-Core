...
class BAPMC_IC_pack : USP_REEBOW_3DAP_ACC9_BLK
{
  ...
  displayName = "IC Pack (Black)";

  class TransportMagazines
  {
    class _xx_tsp_breach_popper_mag
    {
      count = 5;
    ...
    class _xx_UK3CB_BAF_SmokeShellPurple
    {
      count = 2;
      magazine = "UK3CB_BAF_SmokeShellPurple";
    };
    class _xx_tsp_flashbang_cts
    {
      count = 1;
      magazine = "tsp_flashbang_cts";
    };
...
class BAPMC_Surgeon_pack : USP_45L_RUCKSACK
{
  ...
  displayName = "Surgeon Pack (Black)";
  ...
  class TransportItems
  {
    ...
    class _xx_kat_phenylephrineAuto
    {
      count = 6;
...
class BAPMC_Helicopter_Pilot_pack : USP_REEBOW_3DAP_ACC9_BLK
{
  ...
  displayName = "Helicopter Pilot Pack (Black)";
  class TransportMagazines
  {
  };
  class TransportItems
...
{
  scopeArsenal = 1;
  scopeCurator = 1; // hide the base
  maximumLoad = WS_MAXLOAD;
  mass = WS_MASS;
  scope = 2;

  displayName = "Pilot Pack (Black)";
...
class BAPMC_Fixed_Wing_Crew_pack : USP_REEBOW_3DAP_ACC9_BLK
{
  ...
  displayName = "Fixed Wing Crew Pack (Black)";
  class TransportMagazines
  {
  };
  class TransportItems
...
class BAPMC_Vic_Crew_pack : USP_REEBOW_3DAP_ACC9_BLK
{
  ...
  displayName = "Vehicle Crew Pack (Black)";
  class TransportMagazines
  {
  };
  class TransportItems
