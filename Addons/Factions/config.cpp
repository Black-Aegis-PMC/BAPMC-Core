class CfgPatches
{
  class BAPMC_Factions
  {
    ...
    units[] = {
        ...
        "BAPMC_Vic_Crew_pack"};
    weapons[] = {};
    equipment[] = {"BAPMC_Kitbag", "BAPMC_IC_pack", "BAPMC_Surgeon_pack", "BAPMC_Medic_pack", "BAPMC_Rifleman_pack", "BAPMC_Cadet_pack", "BAPMC_Helicopter_Pilot_pack", "BAPMC_Pilot_pack", "BAPMC_Fixed_Wing_Crew_pack", "BAPMC_Helicopter_Crew_pack"
    };
    magazines[] = {};
    ammo[] = {};
    worlds[] = {};
