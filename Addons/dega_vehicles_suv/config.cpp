...
class CfgVehicles
{
	...
	class DEGA_ArmoredSUV_Base: Car_F
	{
		...
		displayName = "[BA-PMC] Armoured Suburban";
		...
		crew = "BAPMC_Rifleman";
		typicalCargo[] = {BAPMC_Rifleman, BAPMC_Rifleman, BAPMC_Rifleman, BAPMC_Medic, BAPMC_IC};
...
/*		class HitPoints: HitPoints
	...
	class DEGA_GunArmoredSUV_PMC: DEGA_ArmoredSUV_Base
	{
		...
		displayName = "[BA-PMC] Armoured Suburban (Minigun)";
